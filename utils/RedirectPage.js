...
export class RedirectPage{
    ...
    redirectToPathMap() {
        let map = new Map()
            ...
            .set("pages/kaidanbaoIndex/kaidanbaoIndex", "pagesKaidanbao/kaidanbaoIndex/kaidanbaoIndex")  // 个人微店
            .set("packageWeb/pages/takeLook/takeLook", "pagesWeb/takeLook/takeLook")  // 带看确认书web
            .set("packageWeb/pages/standingOrder/standingOrder", "pagesWeb/standingOrder/standingOrder")  // 委托书签订
            .set("packageProperty/pages/findHouse/findHouse", "pagesProperty/findHouse/findHouse")  // 委托登记
            .set("packageStore/pages/compStore/compStore", "pagesStore/compStore/compStore")  // 旗舰店
            .set("packageShare/pages/contractInfo/contractInfo", "pagesShare/contractShare/contractProcess")  // 线上合同

            // 以下是C端老的分享
            .set("pages/real_index/index", "pages/index/index")   // 首页
            .set("pages/news/news", "pages/message/message")    // 消息
            .set("pages/mine/mine", "pages/my/my")   // 我的
