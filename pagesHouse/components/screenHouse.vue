			...
			<view class="screen_view">
				...
				<view class="screen_list f_r_b" v-if="enterType == 'erHouse'">
					<view hover-class="none" form-type="submit" @click="screenBtn('region')" class="screen_item f_r_c">
						<view :style="{color: screenFormData.erHouse.region.show || screenFormData.erHouse.region.text != '区域' ? '#ab7f2e' : '#494949'}"
					...
					<view hover-class="none" form-type="submit" @click="screenBtn('price')" class="screen_item f_r_c">
						<view :style="{color: screenFormData.erHouse.price.show || screenFormData.erHouse.price.text != priceApiDataMap[from].defaultText ? '#ab7f2e' : '#494949'}"
					...
					<view hover-class="none" form-type="submit" @click="screenBtn('room')" class="screen_item f_r_c">
						<view :style="{color: screenFormData.erHouse.room.show || screenFormData.erHouse.room.text != '户型' ? '#ab7f2e' : '#494949'}"
					...
					<view hover-class="none" form-type="submit" @click="screenBtn('more')" class="screen_item f_r_c">
						<view :style="{color: screenFormData.erHouse.more.show || screenFormData.erHouse.more.text != '更多' ? '#ab7f2e' : '#494949'}"
				...
				<view class="screen_list f_r_b" v-if="enterType == 'newHouse'">
					<view hover-class="none" form-type="submit"
						...
						<view :style="{color: screenFormData[enterType].region.show || screenFormData[enterType].region.text != '区域' ? '#ab7f2e' : '#494949'}"
					...
					<view hover-class="none" form-type="submit" @click="screenBtn('price')" class="screen_item f_r_c">
						<view :style="{color: screenFormData.newHouse.price.show || screenFormData.newHouse.price.text != priceApiDataMap[from].defaultText ? '#ab7f2e' : '#494949'}"
					...
					<view hover-class="none" form-type="submit" @click="screenBtn('type')" class="screen_item f_r_c">
						<view :style="{color: screenFormData.newHouse.type.show || screenFormData.newHouse.type.text != '用途' ? '#ab7f2e' : '#494949'}"
				...
				<view class="screen_list f_r_b" v-if="enterType == 'apartment'">
					<view hover-class="none" form-type="submit" @click="screenBtn('region')" class="screen_item f_r_c">
						<view :style="{color: screenFormData.apartment.region.show || screenFormData.apartment.region.text != '区域' ? '#ab7f2e' : '#494949'}"
					...
					<view hover-class="none" form-type="submit" @click="screenBtn('price')" class="screen_item f_r_c">
						<view :style="{color: screenFormData.apartment.price.show || screenFormData.apartment.price.text != priceApiDataMap[from].defaultText ? '#ab7f2e' : '#494949'}"
					...
					<view hover-class="none" form-type="submit" @click="screenBtn('chuZuType')" class="screen_item f_r_c">
						<view :style="{color: screenFormData.apartment.chuZuType.show || screenFormData.apartment.chuZuType.text != '出租方式' ? '#ab7f2e' : '#494949'}"
					...
					<view hover-class="none" form-type="submit" @click="screenBtn('more')" class="screen_item f_r_c">
						<view :style="{color: screenFormData.apartment.more.show || screenFormData.apartment.more.text != '更多' ? '#ab7f2e' : '#494949'}"
				...
				<view @click="screenClose" :style="{height: fixedContHeight, top: fixedTcTop}"
					...
					<view :style="{height: contHeight}" @click.stop="screenContBtn"
						...
						<scroll-view class="region_scroll_left" scroll-y>
							<block v-for="(item, index) in regionLeftList" :key="index">
								<view hover-class="none" form-type="submit" :class="{'region_left_active global-font-color': regionLeftIndex == index}"
						...
						<scroll-view class="region_scroll_right" scroll-y>
							<block v-for="(item, index) in regionRightMap[screenFormData[enterType].region.leftId]" :key="index">
								<view hover-class="none" form-type="submit" :class="{'screen_active global-font-color': regionRightIndex == index}"
					...
					<view :style="{height: contHeight}" @click.stop="screenContBtn"
						...
						<scroll-view class="scroll_view_list price_scroll_list" scroll-y>
							<block v-for="(item, index) in erHousePriceList" :key="index">
								<view hover-class="none" form-type="submit" :class="{'screen_active global-font-color': erHousePriceIndex == index}"
						...
						<view class="price_bottom_view f_r_b">
							<view class="f_r_s">
								<input :value="minPriceVal" @input="minPriceBlur" class="price_input_val" placeholder="最低价格" />
								<input :value="maxPriceVal" @input="maxPriceBlur" class="price_input_val" placeholder="最高价格" />
							</view>

							<view hover-class="none" form-type="submit" @click="confirmPrice" class="price_bottom_confirm global-confirm-btn">确定</view>
						</view>
					</view>
					...
					<view :style="{height: contHeight}" @click.stop="screenContBtn"
						...
						<scroll-view class="scroll_view_list" scroll-y>
							...
							<view class="region_new_cont f_r_s">
								<block v-for="(item, index) in roomList" :key="index">
									<view hover-class="none" form-type="submit" :class="{'screen_active global-selecet-box': roomListIndex == index}"
										v-if="item.id"
						...
						<view class="room_new_btn_view">
							...
							<view hover-class="none" form-type="submit" @click='roomBtn(roomItem, 0)' class="room_new_btn_confirm global-confirm-btn">确认</view>
						</view>
					</view>
					...
					<view :style="{height: contHeight}" @click.stop="screenContBtn"
								...
								<view class="more_list">
									...
									<view class="more_cont f_r_s">
										<block v-for="(item, index) in aparmentMoreMap['ruZhuTime'].list" :key="index">
											<view hover-class="none" form-type="submit"
												:class="{ 'more_item_active global-selecet-box': index == aparmentMoreMap['ruZhuTime'].index }"
								...
								<view class="more_list">
									...
									<view class="more_cont f_r_s">
										<block v-for="(item, index) in aparmentMoreMap['room'].list" :key="index">
											<view hover-class="none" form-type="submit"
												:class="{ 'more_item_active global-selecet-box': index == aparmentMoreMap['room'].index }"
								...
								<view class="more_list">
									...
									<view class="more_cont f_r_s">
										<block v-for="(item, index) in aparmentMoreMap['area'].list" :key="index">
											<view hover-class="none" form-type="submit"
												:class="{ 'more_item_active global-selecet-box': index == aparmentMoreMap['area'].index }"
								...
								<view class="more_list">
									...
									<view class="more_cont f_r_s">
										<block v-for="(item, index) in aparmentMoreMap['sex'].list" :key="index">
											<view hover-class="none" form-type="submit"
												:class="{ 'more_item_active global-selecet-box': index == aparmentMoreMap['sex'].index }"
								...
								<view class="more_list">
									...
									<view class="more_cont f_r_s">
										<block v-for="(item, index) in aparmentMoreMap['specail'].list" :key="index">
											<view hover-class="none" form-type="submit"
												:class="{ 'more_item_active global-selecet-box': index == aparmentMoreMap['specail'].index }"
								...
								<view class="more_list">
									...
									<view class="more_cont f_r_s">
										<block v-for="(item, index) in sourceLsit" :key="index">
											<view hover-class="none" form-type="submit" :class="{ 'more_item_active global-selecet-box': index == sourceLsitIndex }"
								...
								<view class="more_list">
									...
									<view class="more_cont f_r_s">
										<block v-for="(item, index) in areaLsit" :key="index">
											<view hover-class="none" form-type="submit" :class="{ 'more_item_active global-selecet-box': index == areaLsitIndex }"
								...
								<view class="more_list">
									...
									<view class="more_cont f_r_s">
										<block v-for="(item, index) in typeLsit" :key="index">
											<view hover-class="none" form-type="submit" :class="{ 'more_item_active global-selecet-box': index == typeLsitIndex }"
								...
								<view v-if="from == 'erHouse'" class="more_list">
									...
									<view class="more_cont f_r_s">
										<block v-for="(item, index) in specialList" :key="index">
											<view hover-class="none" form-type="submit" :class="{ 'more_item_active global-selecet-box': index == specialListIndex }"
						...
						<view class="f_r_b more_btn_view">
							...
							<view hover-class="none" form-type="submit" @click="confirmBtn" class="confirmBtn global-confirm-btn">确定</view>
						</view>
					</view>
					...
					<view :style="{height: '55%'}" @click.stop="screenContBtn"
						...
						<scroll-view class="scroll_view_list price_scroll_list"
							...
							<block v-for="(item, index) in newHouseTypeList" :key="index">
								<view hover-class="none" form-type="submit" :class="{'screen_active global-font-color': newHouseTypeListIndex == index}"
					...
					<view :style="{height: contHeight}" @click.stop="screenContBtn"
						...
						<view class="new_house_price_change_view">
							<view @click="newHousePriceTab(0)" :class="{ 'new_price_tab_active global-font-color' : newHousePriceTabIndex == 0 }">均价</view>
							<view @click="newHousePriceTab(1)" :class="{ 'new_price_tab_active global-font-color' : newHousePriceTabIndex == 1 }">总价</view>
						</view>
						<scroll-view style="background: #F8F8F9;" class="scroll_view_list price_scroll_list" scroll-y>
							<block v-for="(item, index) in newHousePriceListMap[newHousePriceTabIndex]" :key="index">
								<view hover-class="none" form-type="submit"
									:class="{'screen_active global-font-color': newHousePriceListIndexMap[newHousePriceTabIndex] == index}"
					...
					<view :style="{height: '35%'}" @click.stop="screenContBtn"
						...
						<scroll-view class="scroll_view_list price_scroll_list"
							...
							<block v-for="(item, index) in aparmentChuZuTypeList" :key="index">
								<view hover-class="none" form-type="submit" :class="{'screen_active global-font-color': aparmentChuZuTypeListIndex == index}"
	...
	export default {
		data() {
			return {
                ...
                topIcon: "http://cdn.haofang.net/static/wxPlusApp/yjk/house/down-active.png",
        ...
        methods: {
                ...
                setTimeout(() => {
                    ...
                    view.boundingClientRect(data => {
                        if(currentClickType === "more" || currentClickType === "price") {
							this.contHeight = "60%";
							privateData[currentClickType].height = "60%";
                            return;
                        }
			...
			resetBtn() {
				...
				this.specialListIndex = -1;
				if (screenFormData[enterType].specail) {
					screenFormData[enterType].specail.id = "";
					screenFormData[enterType].specail.text = "特色";
				}
				...
				this.areaLsitIndex = -1;
				if (screenFormData[enterType].area) {
					screenFormData[enterType].area.id = "";
					screenFormData[enterType].area.text = "面积";
				}

				this.sourceLsitIndex = -1;
				if (screenFormData[enterType].source) {
	screenFormData[enterType].source.id = "";
	screenFormData[enterType].source.text = "来源";
}

				if (screenFormData[enterType].ruZhuTime) {
					screenFormData[enterType].ruZhuTime.id = "";
					screenFormData[enterType].ruZhuTime.text = "入住时间";
				}

				if (screenFormData[enterType].room && enterType === "apartment") {
					screenFormData[enterType].room.id = "";
					screenFormData[enterType].room.text = "户型";
				}
				...
				if (screenFormData[enterType].sex) {
					screenFormData[enterType].sex.id = "";
					screenFormData[enterType].sex.text = "性别";
				}
				...
				let aparmentMoreMap = this.aparmentMoreMap;
				for (let k in aparmentMoreMap) {
					aparmentMoreMap[k].index = -1;
				}
				this.aparmentMoreMap = aparmentMoreMap;
				this.screenFormData = screenFormData;
			},
