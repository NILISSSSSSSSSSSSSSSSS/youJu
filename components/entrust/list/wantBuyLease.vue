<template>
	<view>
        <view class="want_trust_view"
            ...
            <view class="f_r_s want_buy_lease_view">
                ...
                <view class="want_buy_lease_cont">
                    ...
                    <view class="f_r_s want_buy_lease_des">
                        ...
                        <view v-if="item.room">{{ item.room }}室</view>
            ...
            <!-- 抢单状态 -->
            <view class="want_trusting_con f_r_s"
                  v-if="item.entrustUsers && item.entrustUsers.length == 0 && item.trustStatus == 1">
                <view class="want_trusting_icon"></view>
                <view class="want_trusting_txt f_c_c">全城经纪人正在抢单中</view>
            </view>
