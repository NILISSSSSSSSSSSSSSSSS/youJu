		...
		<view class="f_r_s">
			<view class="houseMeView_cont">
				<view class="houseMeView_name">
					...
					<text v-if="item.content.houseArea">{{ item.content.houseArea }}{{ item.content.houseAreaUnit }}</text>
			...
			<!-- 	<view class="f_r_s houseMeView_ting">
				...
				<view class="main_color">
					<text class=" houseMeView_total" v-if="item.content.houseTotalPrice">
						{{ item.content.houseTotalPrice }}{{ item.content.houseTotalPriceUnit?item.content.houseTotalPriceUnit:'万' }}
					</text>
