...
主要文件介绍：
	utils下的文件：
		...
		UserBehavior.js  用户行为统计方法都在此开发和调用；
...
组件和样式兼容写法问题：
    ...
    border-radius: 在ios上圆角会闪一下再变成圆角，加上 will-change: transform 这个样式即可（意思相当于提前告知程序这个是圆角）;
...
全局的组件和方法
	...
	UserBehavior: 用户行为统计  使用方法 new UserBehavior();
...
百度小程序提审文案：
    优优好房提供真实的租房、二手房、整租、合租等房产信息，以及房产常用小工具。
